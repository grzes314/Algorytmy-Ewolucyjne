 ...
 * @author grzes
 */
public class LabDesignerWithRects extends javax.swing.JPanel
{
    public final LabDataWithRects labData;
     ...
     */
    public LabDesignerWithRects(LabDataWithRects labData)
    {
        this.labData = labData;
        initComponents();
    }
    
    public LabDesignerWithRects(Point minArea, Point maxArea)
    {
        this.labData = new LabDataWithRects(minArea, maxArea);
        initComponents();
    }
